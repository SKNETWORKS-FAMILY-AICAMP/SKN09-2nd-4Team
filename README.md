...
### 프로젝트 필요성(배경)
은행 산업은 높은 경쟁 속에서 운영되며, 고객 이탈은 수익성에 큰 영향을 미칩니다. 금융 시장이 디지털화되면서 고객의 선택지가 늘어나고, 만족도가 낮은 고객은 쉽게 경쟁사로 이동할 수 있습니다. 따라서 고객 이탈을 최소화하는 것이 은행의 지속적인 성장과 안정적인 수익 확보에 필수적입니다.

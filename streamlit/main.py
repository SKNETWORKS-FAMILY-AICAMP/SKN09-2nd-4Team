...
<center style="padding:10px;border-radius:10px; padding-top:0">
...
with col1:
    ...
    st.write('다양한 머신러닝 모델을 사용하여 고객 이탈을 예측하고 최적의 모델을 사용함으로써 정확도를 높입니다.')
with col2:
    st.image(path+"/res/img/chart3.png", use_container_width=True)
    st.write('고객 이탈을 예측하기 위한 다양한 시각화 지표를 제공하여 인사이트 도출에 도움을 줍니다.')
with col3:
    st.image(path+"/res/img/chart2.webp", use_container_width=True)
    st.write('합리적인 비용으로 고객 이탈을 예측하고 최적의 전략을 수립하여 보다 나은 서비스를 제공합니다.')
# st.html('''
